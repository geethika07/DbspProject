...
import PlanComparison from "../Comparator/Comparator";
...
const FormOutput = (props) => {
    ...
    // If we have data, check what's the best plan. If it's the original, then just say it like you mean it.
      ...
      return (
        <>
          ...
          <p>This indicates that PostgreSQL has likely chosen the best possible QEP, with alternative QEPs in the close selectivity range failing to offer considerable performance improvements.</p>
  ...
  return (
    <>
      ...
      <p>Select two query execution plans to compare.</p>
      ...
      {/* <hr /> */}
      <br />
      <h3 style={{ textAlign: "center", marginBottom: "1rem" }}>Explanation for best plan</h3>
      ...
      <p style={{textAlign:"left"}}>The original QEP recommended by postgres is shown on the left. If there's any alternative plan which is better than original plan it is shown in the right by default. Select any two query execution plans to compare.</p>
      <hr />
      <Form.Row className={styles.explanationWrapper}>
      ...
      <hr />
      <Form.Row className={styles.visualizationWrapper}>
      ...
      <hr />
      <Form.Row>
        <Form.Group as={Col} controlId="formExplanation1" className={styles.flexRowEqualHeight}>
